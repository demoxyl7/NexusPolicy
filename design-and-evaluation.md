...
| TC-08 | Scope | "How do I get Quantic policies?" | Refusal: "I can only answer policy questions." | Out-of-Scope |
...
| TC-10 | Remote Work | "Condition for employee termination?" | Continued policy violations following a final written warning. A single incident of sufficiently serious misconduct. | `remote_work.md` |
